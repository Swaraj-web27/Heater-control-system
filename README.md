...
6. Conclusion
In this activity, we successfully developed a simple heater control system in C that takes user input to turn the heater on or off. By taking 0 or 1 as input  to switch off or on the heater. 
